...
private:
    ...
    int getInt(const string &erro)
    {
        ...
        while (cin.fail())
        {
            ...
            // limpa os erros
            cin.clear();
            // ignora os caracteres do buffer de entrada
            cin.ignore(1000, '\n');
            cin >> valor;
        }
    ...
    void recebe()
    { // recebe a linha especifica e atribui a m_personagens[x]
        position = 0;
        string linhas;
    ...
    { // pega a linha de recebe itens e adiciona os itens daquela linha no vetor x
    ...
    void recebe_itens()
    { // le cada linha do arquivo dos itens para atribuir os itens de todo o vetor
    ...
    int gera_id()
    { // gera um id diferente de todos os existentes
...
public:
    ...
    void escreve_lista()
    { // escreve os personagens no arquivo fichas .txt
    ...
    { // escreve os atributos dos personagens em status fichas.txt
    ...
    void escreve_inv()
    { // escreve os itens dos vetores em itens fichas.txt
    ...
    {                    // escreve os 3 arquivos em sequencia
        escreve_lista(); //
        escreve_lista_status();
        escreve_inv();
    }
    void atualiza()
    { // escreve o vetor atualizado e recebe
        escreve_arquivos();
        receba_();
    }
    itens padrao_inv(itens inventario)
    { // itens padrão para um novo jogador(pode editr dps se quiser)
    ...
    { // imprime somente um elemento especifico
    ...
    void busca()
    {
        ...
        if (escolha >= 1 && escolha <= 5)
        {
            ...
            else
            {
                ...
                { // verifica se deseha buscar outro
    ...
    void remove()
    {
        ...
        if (!encontrado)
        { // se não for encontrado ele avisa
            cout << "jogador não encontrado" << endl;
        }
        position--;
        cout << position << endl;
